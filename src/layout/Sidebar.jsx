  ...
  return (
    ...
    >
      ...
      >
        {showSide ? (
          <span
            className="text-minionBlue p-2 bg-white shadow-md rounded-full flex  items-center 
      ...
      <div className="w-full overflow-hidden">
        <Link to="/" className="flex items-center gap-4 pl-4">
          <img src="/logo.svg" alt="Logo" className="logo-animate w-14 h-14" />
                  ...
                  >
                    {route.submenu ? (
                      ...
                      <NavLink
                        ...
                        to={route.path}
                        onClick={() =>
                          dispatch(changeExpandedSide({ id: index }))
                        }
