  ...
  const getCart = async () => {
    try {
      const res = await axios.get(
        process.env.REACT_APP_API_BASE_URL + "/api/product/cart",
        {}
      );
              ...
              >
                ...
                <div className="p-8 flex flex-col items-center">
                  <p className="text-center text-gray-700 text-2xl font-semibold truncate flex-col  items-center gap-6">
                    {product.name}{" "}
                    <span className="mt-4 text-minionBlue justify-center bg-minionLightBlue px-4 py-1 rounded-full flex text-lg items-center gap-2">
                      <Category />
