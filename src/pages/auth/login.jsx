  ...
  return (
    <>
      <div className={` ${loading && "blur-[2px]"} relative min-h-screen`}>
        ...
        <form
          onSubmit={onSubmit}
          className="absolute top-[50%] left-[50%] font-satoshi  -translate-x-1/2 -translate-y-1/2 w-[90%] md:w-[500px] md:min-h-[550px] shadow-md bg-white  rounded-2xl px-10 md:px-20 pt-20 pb-12"
        >
          <figure className="flex items-center gap-3 justify-center">
            <img
              src="/logo.svg"
              alt="Logo"
