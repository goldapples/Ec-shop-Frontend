  ...
  return (
    <>
      <div className="relative min-h-screen">
        ...
        <form
          onSubmit={onSubmit}
          className="absolute top-[50%] left-[50%] font-satoshi rounded-2xl -translate-x-1/2 -translate-y-1/2 md:w-[500px] md:min-h-[700px] shadow-md  bg-white px-10 md:px-20 pt-20 pb-12"
        >
