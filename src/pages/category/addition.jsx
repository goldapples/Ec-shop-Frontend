          ...
          <div className="flex justify-center h-[73vh] items-center ">
            ...
            >
              ...
              <input
                ...
                className="focus:border font-normal text-lg focus:outline-none bg-gray-100 focus:border-minionBlue pt-1 pl-[10px] pb-1 rounded-md mt-[20px] w-[280px] sm:w-[400px] md:w-[600px] h-[48px]"
              />
              <label
              ...
              <textarea
                ...
                className="focus:border font-normal text-lg focus:outline-none bg-gray-100 focus:border-minionBlue pt-1 pl-[10px] pb-1 rounded-md mt-[20px] w-[280px] sm:w-[400px] md:w-[600px] h-[200px]"
              />
              <div className="flex gap-3 md:justify-end pt-[30px] justify-end">
                <Link
                  to={"../"}
                  replace={true}
                  type="submit"
