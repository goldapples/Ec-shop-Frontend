            ...
            <Link to={`/app/article/${item?.articleId}`} key={key}>
              <div className="h-[50px] border-b-2 rounded-l-lg flex justify-between items-center cursor-pointer hover:bg-[#ddfaff] duration-300 ease-linear ">
                <div className="flex items-center">
                  ...
                  >
                    <img
                      className=" w-11 h-11 rounded-full mt-2 mb-2"
                      src={
                        item?.avatar?.length
                  ...
                  <h1 className=" text-lg ml-6 truncate w-30  sm:w-fit xm:w-[100px]">
                    {item?.title}
                  </h1>
                </div>
                <div className="flex items-center gap-5 pr-4">
                  <div className="flex items-center sm:w-full xm:w-[100px]">
