        ...
        <div className="container mx-auto">
          <div className="relative text-lg font-times rounded-[10px]">
            <div className="w-full">
              <div className="w-full flex flex-col md:flex-row gap-y-4 justify-between items-center mb-10">
                <div className="text-2xl text-gray-700 flex justify-between items-center w-full md:w-[unset] flex-wrap gap-y-4">
                  Total :{" "}
                ...
                <div className="flex flex-row gap-5 w-full md:w-fit">
                  <div className="border border-minionBlue rounded-[10px] py-1 px-2 flex items-center w-full">
                    ...
                    <input
                      ...
                      name=""
                      id=""
                      className="outline-none md:w-[250px] w-full text-gray-700"
                      placeholder="Search..."
                    />
                  </div>
                </div>
              </div>
              <div className="overflow-x-auto w-full h-[650px] overflow-y-auto">
